...
Assuming that you are testing it on localhost try the following urls
	...
	http://localhost/sum.json
	should return 0
	
	http://localhost/sum.xml
	should return the following xml (view source if required)
	<?xml version="1.0"?>
	<result>0</result>
	
	http://localhost/sum.json?num1=10&num2=4
	should return 14
	
	http://localhost/multiply.json/4/2
	should return 8
	
	http://localhost/protectedsum.json?n1=5&n2=4
