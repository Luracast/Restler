...
if (! function_exists('trace')) {
    ...
    function trace ($o, $level=LOG_NOTICE)
    {
        ...
        $i = debug_backtrace();
        $info = array('level'=>$level, 'file'=>$i[0]['file'], 
        	'line'=>$i[0]['line']);
...
class DebugFormat implements iFormat
{
    ...
    public function header ()
    {
        ...
        foreach (self::$traces as $i => $o) {
            ...
            .self::$traceInfos[$i]['source']."</strong>: {$o} </a>";
        }
...
EOT;
    ...
    public function footer ()
    {
        ...
        //$requestHeaders = $this->encode(apache_request_headers(), FALSE, FALSE);
