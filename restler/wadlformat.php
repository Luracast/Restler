...
<application xmlns="http://research.sun.com/wadl/2006/10">
    ...
    <resources base="http://localhost:9998/">
        ...
        XmlFormat::$nameSpaces = array('xmlns'=>'http://wadl.dev.java.net/2009/02', 'xmlns:xsd'=>'http://www.w3.org/2001/XMLSchema');
        XmlFormat::$attributeNames = array('xmlns','xmlns:xsd', 'base', 'path', 'name', 
        'title', 'id');
        ...
        $resource = array('path' => $this->restler->url, 
        'method' => array('name' => $this->restler->requestMethod, 
        'id' => $info->methodName, 'response' => array()));
