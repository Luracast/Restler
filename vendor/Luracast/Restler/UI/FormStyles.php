...
class FormStyles
{
    ...
    public static $bootstrap3 = array(
        'form' => 'form[role=form id=$id# name=$name# method=$method# action=$action# enctype=$enctype#]',
        'input' => '.form-group>label{$label#}+input.form-control[id=$id# name=$name# value=$value# type=$type# required=$required# autofocus=$autofocus# placeholder=$default# accept=$accept# disabled=$disabled#]',
        'textarea' => '.form-group>label{$label#}+textarea.form-control[id=$id# name=$name# required=$required# autofocus=$autofocus# placeholder=$default# rows=3 disabled=$disabled#]{$value#}',
        'radio' => 'fieldset>legend{$label#}>.radio*options>label>input.radio[name=$name# value=$value# type=radio checked=$selected# required=$required# disabled=$disabled#]{$text#}',
        ...
        'fieldset' => 'fieldset>legend{$label#}',
        'checkbox' => '.checkbox>label>input[id=$id# name=$name# value=$value# type=checkbox checked=$selected# required=$required# autofocus=$autofocus# disabled=$disabled#]+{$label#}',
        //------------- TYPE BASED STYLES ---------------------//
